...
const LAYERS = [
  {
    name: '入口层 / Tools & API',
    sub: 'llama-cli  ·  llama-server  ·  examples/simple  ·  llama.h 公共 API',
    chapters: ['01-architecture-overview', '12-cli-and-server'],
    color: '#fb923c',
  },
  {
    name: 'libllama 核心',
    sub: 'llama_model  ·  llama_context  ·  llama_batch  ·  vocab  ·  sampler',
    chapters: ['07-context-and-batching', '03-model-arch-and-hparams', '06-tokenization', '10-sampling'],
    color: '#f97316',
  },
  {
    name: '计算图 + 内存调度',
    sub: 'llm_graph  ·  ggml_cgraph  ·  KV cache  ·  backend scheduler',
    chapters: ['05-graph-construction', '04-ggml-tensor-and-graph', '08-kv-cache'],
    color: '#ea580c',
  },
  {
    name: '后端层 / Backends',
    sub: 'CPU  ·  Metal  ·  CUDA  ·  Vulkan  ·  ggml-quants 量化核',
    chapters: ['09-ggml-backend', '13-quantization'],
    color: '#c2410c',
  },
];
