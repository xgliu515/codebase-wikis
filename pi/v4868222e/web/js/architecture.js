...
const LAYERS = [
  {
    name: 'TUI / 终端 UI 库',
    sub: 'TUI 主循环  ·  差分渲染  ·  ProcessTerminal  ·  Kitty 协议  ·  12 内置组件  ·  keys.ts 解码',
    chapters: ['10-tui-renderer', '11-tui-components-and-keys'],
    color: '#fb923c',
  },
  {
    name: 'Coding Agent / CLI 应用',
    sub: 'main.ts  ·  AgentSessionRuntime  ·  7 内置工具  ·  扩展系统  ·  InteractiveMode  ·  Settings',
    chapters: ['07-coding-agent-cli-startup', '08-coding-agent-tools', '09-coding-agent-extensions', '12-interactive-mode', '13-config-and-sessions'],
    color: '#f97316',
  },
  {
    name: 'Agent Runtime / 编排循环',
    sub: 'agentLoop  ·  AgentEvent  ·  tool 调用闭环  ·  Session JSONL  ·  Compaction',
    chapters: ['05-agent-runtime-loop', '06-agent-runtime-sessions-compaction'],
    color: '#ea580c',
  },
  {
    name: 'AI 层 / 多 Provider LLM API',
    sub: 'stream/streamSimple  ·  api-registry  ·  Anthropic/OpenAI/Google/Bedrock  ·  OAuth & API key  ·  models.generated',
    chapters: ['02-ai-layer-providers-registry', '03-ai-provider-implementations', '04-ai-auth-and-oauth'],
    color: '#c2410c',
  },
];
