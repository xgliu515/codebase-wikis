...
const LAYERS = [
  {
    name: '入口层 / Entrypoint',
    sub: 'SGLang DSL  ·  HTTP Server  ·  Engine  ·  TokenizerManager',
    chapters: ['02-frontend-language', '03-http-server', '04-engine-and-processes'],
    color: '#fb923c',
  },
  {
    name: '调度层 / Scheduler',
    sub: 'Scheduler 事件循环  ·  ScheduleBatch  ·  调度策略',
    chapters: ['08-scheduler', '05-request-data-structures'],
    color: '#f97316',
  },
  {
    name: '内存层 / KV Cache',
    sub: 'RadixCache  ·  ReqToTokenPool  ·  KV 分配器  ·  HiCache',
    chapters: ['06-radix-cache', '07-kv-cache-memory'],
    color: '#ea580c',
  },
  {
    name: '执行层 / Execution',
    sub: 'ModelRunner  ·  ForwardBatch  ·  Attention Backend  ·  Sampler',
    chapters: ['09-model-runner', '10-attention-backends', '11-sampling-constrained', '12-speculative-decoding'],
    color: '#c2410c',
  },
];
