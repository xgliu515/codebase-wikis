...
<svg viewBox="0 0 820 480" xmlns="http://www.w3.org/2000/svg" class="figure-svg" role="img" aria-label="Trunk and sibling channels branch topology: trunk holds the adapter interface and CLI only, channels branch holds all platform adapters fetched on demand"><defs><marker id="ar11a" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto"><path d="M0,0 L10,5 L0,10 z" fill="#94a3b8"/></marker></defs><text x="410" y="22" text-anchor="middle" font-size="14" font-weight="700" fill="currentColor">trunk + sibling branch 拓扑 — 按需 git fetch + skill 落地</text><g><rect x="40" y="50" width="740" height="180" rx="8" fill="#99f6e4" stroke="#0d9488" stroke-width="1.5"/><text x="410" y="74" text-anchor="middle" font-size="13" font-weight="700" fill="currentColor">trunk (主干) — 始终存在，约 300 KB</text><g><rect x="60" y="92" width="340" height="36" rx="4" fill="#ffffff" stroke="#cbd5e1"/><text x="74" y="115" font-size="11" font-weight="600" fill="currentColor">src/channels/adapter.ts</text><text x="390" y="115" text-anchor="end" font-size="10" fill="#64748b">ChannelAdapter 接口</text></g><g><rect x="60" y="134" width="340" height="36" rx="4" fill="#ffffff" stroke="#cbd5e1"/><text x="74" y="157" font-size="11" font-weight="600" fill="currentColor">src/channels/channel-registry.ts</text><text x="390" y="157" text-anchor="end" font-size="10" fill="#64748b">注册中心 + init</text></g><g><rect x="60" y="176" width="340" height="36" rx="4" fill="#ffffff" stroke="#cbd5e1"/><text x="74" y="199" font-size="11" font-weight="600" fill="currentColor">src/channels/index.ts</text><text x="390" y="199" text-anchor="end" font-size="10" fill="#64748b">barrel (import 副作用)</text></g><g><rect x="420" y="92" width="340" height="36" rx="4" fill="#ffffff" stroke="#cbd5e1"/><text x="434" y="115" font-size="11" font-weight="600" fill="currentColor">src/channels/cli.ts</text><text x="750" y="115" text-anchor="end" font-size="10" fill="#64748b">唯一内置 adapter</text></g><g><rect x="420" y="134" width="340" height="36" rx="4" fill="#ffffff" stroke="#cbd5e1"/><text x="434" y="157" font-size="11" font-weight="600" fill="currentColor">src/channels/chat-sdk-bridge.ts</text><text x="750" y="157" text-anchor="end" font-size="10" fill="#64748b">Vercel Chat SDK 桥</text></g><g><rect x="420" y="176" width="340" height="36" rx="4" fill="#ffffff" stroke="#cbd5e1"/><text x="434" y="199" font-size="11" font-weight="600" fill="currentColor">src/channels/ask-question.ts</text><text x="750" y="199" text-anchor="end" font-size="10" fill="#64748b">跨平台问答原语</text></g></g><g><path d="M 410 230 L 410 280" stroke="#ea580c" stroke-width="2" marker-end="url(#ar11a)"/><rect x="220" y="240" width="380" height="32" rx="6" fill="#fed7aa" stroke="#ea580c"/><text x="410" y="261" text-anchor="middle" font-size="11" font-weight="600" fill="currentColor">/add-&lt;name&gt; skill: git fetch + git show + pnpm install</text></g><g><rect x="40" y="290" width="740" height="170" rx="8" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/><text x="410" y="314" text-anchor="middle" font-size="13" font-weight="700" fill="currentColor">channels (sibling branch) — 按需提取单文件</text><g><rect x="60" y="332" width="220" height="32" rx="4" fill="#ffffff" stroke="#cbd5e1"/><text x="170" y="353" text-anchor="middle" font-size="11" fill="currentColor">src/channels/discord.ts</text></g><g><rect x="295" y="332" width="220" height="32" rx="4" fill="#ffffff" stroke="#cbd5e1"/><text x="405" y="353" text-anchor="middle" font-size="11" fill="currentColor">src/channels/slack.ts</text></g><g><rect x="530" y="332" width="220" height="32" rx="4" fill="#ffffff" stroke="#cbd5e1"/><text x="640" y="353" text-anchor="middle" font-size="11" fill="currentColor">src/channels/telegram.ts</text></g><g><rect x="60" y="372" width="220" height="32" rx="4" fill="#ffffff" stroke="#cbd5e1"/><text x="170" y="393" text-anchor="middle" font-size="11" fill="currentColor">src/channels/whatsapp.ts</text></g><g><rect x="295" y="372" width="220" height="32" rx="4" fill="#ffffff" stroke="#cbd5e1"/><text x="405" y="393" text-anchor="middle" font-size="11" fill="currentColor">src/channels/iMessage.ts</text></g><g><rect x="530" y="372" width="220" height="32" rx="4" fill="#ffffff" stroke="#cbd5e1"/><text x="640" y="393" text-anchor="middle" font-size="11" fill="currentColor">teams / linear / github / ...</text></g><text x="410" y="430" text-anchor="middle" font-size="11" fill="#64748b">setup/channels/*.ts — 每个 channel 的交互式 OAuth 引导</text><text x="410" y="448" text-anchor="middle" font-size="11" fill="#64748b">tests/ — 平台特定的 mock + 集成测试</text></g></svg>
<span class="figure-caption">图 R11.1 ｜ trunk 只保留接口 + registry + CLI + Chat SDK 桥；十几个平台 adapter 留在 channels sibling branch，按需 git fetch 单文件落地。</span>
...
<svg viewBox="0 0 820 480" xmlns="http://www.w3.org/2000/svg" class="figure-svg" role="img" aria-label="ask_question payload roundtrip: agent/host writes outbound, bridge renders card to platform, user clicks, onAction writes question_response and a handler claims it"><defs><marker id="ar11b" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto"><path d="M0,0 L10,5 L0,10 z" fill="#94a3b8"/></marker></defs><text x="410" y="22" text-anchor="middle" font-size="14" font-weight="700" fill="currentColor">ask_question 跨平台问答原语 — 出 + 回往返</text><g><rect x="40" y="50" width="320" height="60" rx="6" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/><text x="200" y="72" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">agent (container) / host</text><text x="200" y="92" text-anchor="middle" font-size="10" fill="#64748b">ask_user_question MCP / requestApproval()</text></g><g><rect x="460" y="50" width="320" height="60" rx="6" fill="#ddd6fe" stroke="#7c3aed" stroke-width="1.5"/><text x="620" y="72" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">outbound.db (per-session)</text><text x="620" y="92" text-anchor="middle" font-size="10" fill="#64748b">kind='chat-sdk', content={type:ask_question,...}</text></g><line x1="360" y1="80" x2="455" y2="80" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar11b)"/><line x1="620" y1="110" x2="620" y2="140" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar11b)"/><text x="640" y="128" font-size="10" fill="#64748b">delivery poll (第 9 章)</text><g><rect x="280" y="140" width="500" height="60" rx="6" fill="#99f6e4" stroke="#0d9488" stroke-width="1.5"/><text x="530" y="162" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">chat-sdk-bridge.deliver</text><text x="530" y="182" text-anchor="middle" font-size="10" fill="#64748b">渲染 Card{Actions{Button[]}} + 索引化编码 (Telegram 64B 上限)</text></g><line x1="530" y1="200" x2="530" y2="220" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar11b)"/><g><rect x="40" y="220" width="200" height="50" rx="6" fill="#0ea5e9" fill-opacity="0.15" stroke="#0ea5e9"/><text x="140" y="240" text-anchor="middle" font-size="11" font-weight="600" fill="currentColor">Discord Embed</text><text x="140" y="258" text-anchor="middle" font-size="10" fill="#64748b">Buttons</text></g><g><rect x="260" y="220" width="180" height="50" rx="6" fill="#0ea5e9" fill-opacity="0.15" stroke="#0ea5e9"/><text x="350" y="240" text-anchor="middle" font-size="11" font-weight="600" fill="currentColor">Slack Blocks</text><text x="350" y="258" text-anchor="middle" font-size="10" fill="#64748b">Actions</text></g><g><rect x="460" y="220" width="180" height="50" rx="6" fill="#0ea5e9" fill-opacity="0.15" stroke="#0ea5e9"/><text x="550" y="240" text-anchor="middle" font-size="11" font-weight="600" fill="currentColor">Telegram</text><text x="550" y="258" text-anchor="middle" font-size="10" fill="#64748b">InlineKeyboard</text></g><g><rect x="660" y="220" width="120" height="50" rx="6" fill="#0ea5e9" fill-opacity="0.15" stroke="#0ea5e9"/><text x="720" y="240" text-anchor="middle" font-size="11" font-weight="600" fill="currentColor">...</text><text x="720" y="258" text-anchor="middle" font-size="10" fill="#64748b">14+ 平台</text></g><g><rect x="220" y="290" width="380" height="36" rx="6" fill="#ffffff" stroke="#0ea5e9" stroke-width="1.5"/><text x="410" y="313" text-anchor="middle" font-size="12" font-weight="700" fill="#0ea5e9">用户在自己的平台 App 上点击按钮</text></g><line x1="410" y1="326" x2="410" y2="346" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar11b)"/><g><rect x="100" y="346" width="620" height="50" rx="6" fill="#99f6e4" stroke="#0d9488"/><text x="410" y="366" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">chat.onAction(event) → setupConfig.onAction(questionId, selectedOption, userId)</text><text x="410" y="384" text-anchor="middle" font-size="10" fill="#64748b">getAskQuestionRender(questionId) 反查下标 → 真实 value + selectedLabel</text></g><line x1="410" y1="396" x2="410" y2="416" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar11b)"/><g><rect x="100" y="416" width="620" height="50" rx="6" fill="#ddd6fe" stroke="#7c3aed" stroke-width="1.5"/><text x="410" y="436" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">写 messages_in (kind=question_response)</text><text x="410" y="454" text-anchor="middle" font-size="10" fill="#64748b">router → dispatchResponse → pending_approvals/sender/channel handler 匹配 questionId</text></g></svg>
<span class="figure-caption">图 R11.2 ｜ ask_question 跨平台问答原语的往返路径：单条 outbound payload → bridge 渲染 → 14+ 平台 UI → onAction → question_response 写回 → handler 匹配。</span>
...
<svg viewBox="0 0 820 540" xmlns="http://www.w3.org/2000/svg" class="figure-svg" role="img" aria-label="Seven-step skill install template: validate creds, check installed, git fetch, copy file, append import, pnpm install pinned version, build, write env and restart"><defs><marker id="ar11c" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto"><path d="M0,0 L10,5 L0,10 z" fill="#94a3b8"/></marker></defs><text x="410" y="22" text-anchor="middle" font-size="14" font-weight="700" fill="currentColor">/add-&lt;name&gt; skill install 模板 — 7 步固定流程</text><g><rect x="40" y="50" width="740" height="50" rx="6" fill="#ddd6fe" stroke="#7c3aed"/><text x="60" y="72" font-size="12" font-weight="700" fill="#7c3aed">1. 校验凭证 env vars</text><text x="60" y="89" font-size="11" fill="#64748b">DISCORD_BOT_TOKEN / APPLICATION_ID / PUBLIC_KEY — 缺则报错退出</text></g><line x1="410" y1="100" x2="410" y2="115" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar11c)"/><g><rect x="40" y="115" width="740" height="50" rx="6" fill="#ddd6fe" stroke="#7c3aed"/><text x="60" y="137" font-size="12" font-weight="700" fill="#7c3aed">2. need_install: 文件存在 &amp; index.ts 已有 import?</text><text x="60" y="154" font-size="11" fill="#64748b">两者皆是 → 跳过 3-6，直接走第 7 步 (幂等)</text></g><line x1="410" y1="165" x2="410" y2="180" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar11c)"/><g><rect x="40" y="180" width="740" height="60" rx="6" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/><text x="60" y="200" font-size="12" font-weight="700" fill="#ea580c">3. git fetch + git show (单文件提取)</text><text x="60" y="217" font-size="11" fill="#64748b">git fetch CHANNELS_REMOTE channels</text><text x="60" y="232" font-size="11" fill="#64748b">git show channels:src/channels/discord.ts &gt; src/channels/discord.ts</text></g><line x1="410" y1="240" x2="410" y2="255" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar11c)"/><g><rect x="40" y="255" width="740" height="50" rx="6" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/><text x="60" y="277" font-size="12" font-weight="700" fill="#ea580c">4. 追加 import 到 barrel</text><text x="60" y="294" font-size="11" fill="#64748b">echo "import './discord.js';" &gt;&gt; src/channels/index.ts (grep 防重复)</text></g><line x1="410" y1="305" x2="410" y2="320" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar11c)"/><g><rect x="40" y="320" width="740" height="50" rx="6" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/><text x="60" y="342" font-size="12" font-weight="700" fill="#ea580c">5. pnpm install — pin 版本</text><text x="60" y="359" font-size="11" fill="#64748b">pnpm install @chat-adapter/discord@4.26.0 — 版本 hardcode 在 skill 里</text></g><line x1="410" y1="370" x2="410" y2="385" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar11c)"/><g><rect x="40" y="385" width="740" height="50" rx="6" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/><text x="60" y="407" font-size="12" font-weight="700" fill="#ea580c">6. pnpm run build</text><text x="60" y="424" font-size="11" fill="#64748b">编译 TypeScript 到 dist/ — 失败则 emit_status failed 并 exit 1</text></g><line x1="410" y1="435" x2="410" y2="450" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar11c)"/><g><rect x="40" y="450" width="740" height="60" rx="6" fill="#ddd6fe" stroke="#7c3aed"/><text x="60" y="470" font-size="12" font-weight="700" fill="#7c3aed">7. 凭证落地 + 重启服务</text><text x="60" y="487" font-size="11" fill="#64748b">写 .env + data/env/env</text><text x="60" y="502" font-size="11" fill="#64748b">launchctl kickstart (macOS) / systemctl restart (Linux)</text></g><g><rect x="600" y="115" width="180" height="170" rx="6" fill="#f0fdf4" stroke="#16a34a" stroke-dasharray="4,3"/><text x="690" y="135" text-anchor="middle" font-size="11" font-weight="700" fill="#16a34a">已装的旁路</text><text x="690" y="155" text-anchor="middle" font-size="10" fill="#64748b">3-6 全跳</text><text x="690" y="175" text-anchor="middle" font-size="10" fill="#64748b">幂等 re-run</text><text x="690" y="200" text-anchor="middle" font-size="10" fill="#64748b">→ 只刷新凭证</text><text x="690" y="220" text-anchor="middle" font-size="10" fill="#64748b">+ 重启服务</text></g></svg>
<span class="figure-caption">图 R11.3 ｜ /add-&lt;name&gt; skill 的 7 步幂等模板：紫色为始终执行的校验/落地，橙色为首次安装才跑的文件操作；已装时跳过 3-6 走旁路。</span>
...
<svg viewBox="0 0 820 540" xmlns="http://www.w3.org/2000/svg" class="figure-svg" role="img" aria-label="Full channel stack layered topology from external platforms down through Chat SDK adapter, bridge, registry, to router and delivery"><defs><marker id="ar11d" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto"><path d="M0,0 L10,5 L0,10 z" fill="#94a3b8"/></marker></defs><text x="410" y="22" text-anchor="middle" font-size="14" font-weight="700" fill="currentColor">完整 channel 栈 — 从外部平台到 router</text><g><rect x="40" y="42" width="740" height="64" rx="8" fill="#0ea5e9" fill-opacity="0.15" stroke="#0ea5e9" stroke-width="1.5"/><text x="410" y="62" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">外部聊天平台</text><text x="60" y="84" font-size="11" fill="#64748b">Discord WS</text><text x="200" y="84" font-size="11" fill="#64748b">Slack Web API</text><text x="350" y="84" font-size="11" fill="#64748b">Telegram bot API</text><text x="510" y="84" font-size="11" fill="#64748b">WhatsApp Cloud</text><text x="660" y="84" font-size="11" fill="#64748b">14+ 平台...</text><text x="60" y="98" font-size="10" fill="#94a3b8">Gateway</text><text x="200" y="98" font-size="10" fill="#94a3b8">webhook</text><text x="350" y="98" font-size="10" fill="#94a3b8">polling/webhook</text><text x="510" y="98" font-size="10" fill="#94a3b8">webhook</text></g><line x1="410" y1="106" x2="410" y2="126" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar11d)"/><text x="430" y="120" font-size="10" fill="#64748b">原始 platform event</text><g><rect x="40" y="126" width="740" height="74" rx="8" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/><text x="410" y="146" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">Chat SDK adapter — @chat-adapter/*</text><text x="60" y="168" font-size="11" fill="#64748b">handlers: onSubscribedMessage · onNewMention · onDirectMessage</text><text x="60" y="186" font-size="11" fill="#64748b">                  onNewMessage(/[\s\S]*/) · onAction</text><text x="760" y="186" text-anchor="end" font-size="10" fill="#94a3b8">互斥 dispatch</text></g><line x1="410" y1="200" x2="410" y2="220" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar11d)"/><text x="430" y="214" font-size="10" fill="#64748b">thread / Message / Card / Button</text><g><rect x="40" y="220" width="740" height="100" rx="8" fill="#99f6e4" stroke="#0d9488" stroke-width="1.5"/><text x="410" y="240" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">chat-sdk-bridge — src/channels/chat-sdk-bridge.ts</text><text x="60" y="262" font-size="11" fill="#64748b">• messageToInbound → ChannelAdapter.onInbound (附件 base64 / author 投影)</text><text x="60" y="280" font-size="11" fill="#64748b">• deliver → adapter.postMessage / editMessage / addReaction</text><text x="60" y="298" font-size="11" fill="#64748b">• state → SqliteStateAdapter (chat_sdk_* 表：subscriptions / locks / kv / lists)</text><text x="60" y="316" font-size="11" fill="#64748b">• openDM / subscribe 桥接 + ask_question 索引化编码</text></g><line x1="410" y1="320" x2="410" y2="340" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar11d)"/><text x="430" y="334" font-size="10" fill="#64748b">ChannelAdapter / InboundMessage / OutboundMessage</text><g><rect x="40" y="340" width="740" height="84" rx="8" fill="#ddd6fe" stroke="#7c3aed" stroke-width="1.5"/><text x="410" y="360" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">channel-registry — src/channels/channel-registry.ts</text><text x="60" y="382" font-size="11" fill="#64748b">• registerChannelAdapter (import 副作用) · getChannelAdapter (按 channelType)</text><text x="60" y="400" font-size="11" fill="#64748b">• initChannelAdapters: NetworkError 2/5/10s 重试 · factory 返 null 跳过</text><text x="60" y="418" font-size="11" fill="#64748b">• 每个 adapter 错独立 catch — 一个挂不拖垮其他</text></g><line x1="410" y1="424" x2="410" y2="444" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar11d)"/><text x="430" y="438" font-size="10" fill="#64748b">router 调 getChannelAdapter(channelType)</text><g><rect x="40" y="444" width="740" height="84" rx="8" fill="#fef2f2" stroke="#dc2626" stroke-width="1.5"/><text x="410" y="464" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">src/router.ts · src/delivery.ts</text><text x="60" y="486" font-size="11" fill="#64748b">• 用户 · 消息组 · 智能体组 · session 实体模型 (第 5 章)</text><text x="60" y="504" font-size="11" fill="#64748b">• 入站路由 / engage 决策 / 出站投递 (第 9 章)</text><text x="60" y="522" font-size="11" fill="#64748b">• 不知道平台细节 — 只跟 ChannelAdapter 接口对话</text></g></svg>
<span class="figure-caption">图 R11.4 ｜ channel 栈五层视图：外部平台 → Chat SDK adapter → bridge → registry → router；trunk 拥有中间三层 (橙/青/紫)，平台 adapter 装在 sibling branch。</span>
