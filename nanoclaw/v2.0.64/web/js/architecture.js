...
const LAYERS = [
  {
    name: '接入层 / Channels',
    sub: 'CLI socket  ·  Chat SDK Bridge  ·  Discord / Slack / Telegram adapters  ·  ask-question',
    chapters: ['11-channels-and-chat-sdk-bridge'],
    color: '#fb923c',
  },
  {
    name: 'Host 调度层 / Router + Loops',
    sub: 'router.ts  ·  delivery.ts  ·  host-sweep.ts  ·  session-manager.ts  ·  container-runner.ts',
    chapters: ['06-inbound-router', '09-outbound-delivery', '10-host-sweep'],
    color: '#f97316',
  },
  {
    name: 'Agent 运行时 / 容器内 Bun 进程',
    sub: 'agent-runner  ·  poll-loop  ·  formatter  ·  providers (Claude SDK)  ·  MCP tools',
    chapters: ['08-agent-runner-poll-loop', '07-session-container-lifecycle'],
    color: '#ea580c',
  },
  {
    name: '存储与基础设施',
    sub: 'central v2.db  ·  per-session inbound.db / outbound.db  ·  OneCLI Vault  ·  Docker / Apple Container',
    chapters: ['03-three-db-model', '12-approvals-and-onecli'],
    color: '#c2410c',
  },
];
