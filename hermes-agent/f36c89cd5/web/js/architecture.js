...
const LAYERS = [
  {
    name: '入口层 / Entrypoint',
    sub: 'hermes 脚本  ·  hermes_cli/main.py  ·  HermesCLI  ·  Gateway  ·  batch_runner',
    chapters: ['02-entrypoints', '13-messaging-gateway'],
    color: '#fb923c',
  },
  {
    name: 'Agent 核心 / Agent Core',
    sub: 'AIAgent  ·  run_conversation  ·  conversation_loop  ·  迭代预算  ·  中断',
    chapters: ['03-conversation-loop', '04-system-prompt'],
    color: '#f97316',
  },
  {
    name: '模型与上下文 / Model & Context',
    sub: 'Provider Adapter  ·  CredentialPool  ·  ContextCompressor  ·  SessionDB',
    chapters: ['07-model-providers', '08-context-compression', '09-session-storage'],
    color: '#ea580c',
  },
  {
    name: '工具与扩展 / Tools & Extensions',
    sub: 'ToolRegistry  ·  Environments  ·  MCP  ·  Skills  ·  Memory  ·  Plugins',
    chapters: ['05-tool-system', '06-terminal-environments', '10-memory-system', '11-skills-and-curator', '12-mcp-and-plugins'],
    color: '#c2410c',
  },
];
