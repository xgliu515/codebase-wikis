...
const LAYERS = [
  {
    name: '接入层 / Channels',
    sub: 'WebChat  ·  Telegram  ·  WhatsApp  ·  Slack  ·  20+ 渠道插件',
    chapters: ['04-channel-layer'],
    color: '#fb923c',
  },
  {
    name: 'Gateway 控制平面',
    sub: 'HTTP/WebSocket Server  ·  RPC 方法注册表  ·  鉴权与 scope',
    chapters: ['02-gateway-control-plane', '14-auth-and-security'],
    color: '#f97316',
  },
  {
    name: '消息编排 / Orchestration',
    sub: '入站管线  ·  会话状态  ·  ReplyDispatcher  ·  事件流',
    chapters: ['05-inbound-pipeline', '06-sessions', '11-delivery-and-events'],
    color: '#ea580c',
  },
  {
    name: 'AI 核心 / Agent Core',
    sub: 'agentCommand  ·  LLM Provider  ·  工具与技能  ·  插件 SDK',
