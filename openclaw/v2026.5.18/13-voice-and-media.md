...
<svg viewBox="0 0 760 300" xmlns="http://www.w3.org/2000/svg" class="figure-svg" role="img" aria-label="能力运行时 to provider-registry to Provider Plugin 三层架构">
  <defs>
  ...
  <rect x="220" y="20" width="240" height="56" rx="8" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/>
  <text x="340" y="44" text-anchor="middle" font-size="13" font-weight="700" fill="currentColor">能力运行时 (runtime)</text>
  <text x="340" y="62" text-anchor="middle" font-size="11" fill="#64748b">归一化参数 / fallback</text>
  <text x="490" y="44" text-anchor="middle" font-size="10" fill="#94a3b8">selects provider,</text>
  <text x="490" y="58" text-anchor="middle" font-size="10" fill="#94a3b8">normalizes params</text>
  <line x1="340" y1="76" x2="340" y2="118" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar1)"/>
  <text x="355" y="102" font-size="10" fill="#64748b">调用</text>
  <rect x="220" y="120" width="240" height="56" rx="8" fill="#99f6e4" stroke="#0d9488" stroke-width="1.5"/>
  <text x="340" y="144" text-anchor="middle" font-size="13" font-weight="700" fill="currentColor">provider-registry</text>
  <text x="340" y="162" text-anchor="middle" font-size="11" fill="#64748b">规范化 id / 别名解析</text>
  <text x="490" y="144" text-anchor="middle" font-size="10" fill="#94a3b8">从插件能力表中</text>
  <text x="490" y="158" text-anchor="middle" font-size="10" fill="#94a3b8">解析 provider 插件</text>
  <line x1="340" y1="176" x2="340" y2="218" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar1)"/>
  <text x="355" y="202" font-size="10" fill="#64748b">返回</text>
  <rect x="220" y="220" width="240" height="56" rx="8" fill="#ddd6fe" stroke="#7c3aed" stroke-width="1.5"/>
  <text x="340" y="244" text-anchor="middle" font-size="13" font-weight="700" fill="currentColor">Provider Plugin 实例</text>
  <text x="340" y="262" text-anchor="middle" font-size="11" fill="#64748b">synthesize / generate...</text>
  <text x="490" y="244" text-anchor="middle" font-size="10" fill="#94a3b8">ElevenLabs / OpenAI /</text>
  <text x="490" y="258" text-anchor="middle" font-size="10" fill="#94a3b8">Deepgram / Twilio ...</text>
</svg>
<span class="figure-caption">图 R13.1 ｜ 语音与媒体能力共享的三层架构：运行时 → registry → Provider 插件</span>
...
<svg viewBox="0 0 760 520" xmlns="http://www.w3.org/2000/svg" class="figure-svg" role="img" aria-label="runMediaUnderstandingFile 处理流程：输入到 buildFileContext 到 normalizeMediaAttachments 到 enabled 检查到 runCapability 到输出">
  <defs>
    ...
    <marker id="ar2d" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto"><path d="M0,0 L10,5 L0,10 z" fill="#94a3b8"/></marker>
  </defs>
  <rect x="170" y="10" width="360" height="40" rx="6" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="1.2"/>
  <text x="350" y="26" text-anchor="middle" font-size="11" font-weight="600" fill="currentColor">输入: filePath / mediaUrl / mime</text>
  <text x="350" y="42" text-anchor="middle" font-size="10" fill="#64748b">+ capability + prompt</text>
  <line x1="350" y1="50" x2="350" y2="78" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar2)"/>
  <rect x="170" y="80" width="360" height="40" rx="6" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/>
  <text x="350" y="97" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">buildFileContext</text>
  <text x="350" y="113" text-anchor="middle" font-size="10" fill="#64748b">区分本地路径 vs 远程 URL，推断 MIME</text>
  <line x1="350" y1="120" x2="350" y2="148" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar2)"/>
  <rect x="170" y="150" width="360" height="40" rx="6" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/>
  <text x="350" y="167" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">normalizeMediaAttachments</text>
  <text x="350" y="183" text-anchor="middle" font-size="10" fill="#64748b">归一化成附件列表</text>
  <line x1="530" y1="170" x2="590" y2="170" stroke="#94a3b8" stroke-width="1.2" stroke-dasharray="3,2" marker-end="url(#ar2d)"/>
  <text x="535" y="163" font-size="10" fill="#64748b">附件为空</text>
  <rect x="592" y="155" width="130" height="30" rx="4" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="1"/>
  <text x="657" y="175" text-anchor="middle" font-size="10" fill="#64748b">outcome: "no-attachment"</text>
  <line x1="350" y1="190" x2="350" y2="218" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar2)"/>
  <rect x="170" y="220" width="360" height="40" rx="6" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="1.2"/>
  <text x="350" y="237" text-anchor="middle" font-size="12" font-weight="600" fill="currentColor">检查 cfg.tools.media[capability].enabled</text>
  <line x1="530" y1="240" x2="590" y2="240" stroke="#94a3b8" stroke-width="1.2" stroke-dasharray="3,2" marker-end="url(#ar2d)"/>
  <text x="535" y="233" font-size="10" fill="#64748b">=== false</text>
  <rect x="592" y="225" width="130" height="30" rx="4" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="1"/>
  <text x="657" y="245" text-anchor="middle" font-size="10" fill="#64748b">outcome: "disabled"</text>
  <line x1="350" y1="260" x2="350" y2="288" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar2)"/>
  <rect x="170" y="290" width="360" height="40" rx="6" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/>
  <text x="350" y="307" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">createMediaAttachmentCache</text>
  <text x="350" y="323" text-anchor="middle" font-size="10" fill="#64748b">建附件缓存（带 SSRF 策略）</text>
  <line x1="350" y1="330" x2="350" y2="358" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar2)"/>
  <rect x="170" y="360" width="360" height="40" rx="6" fill="#99f6e4" stroke="#0d9488" stroke-width="1.5"/>
  <text x="350" y="377" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">runCapability</text>
  <text x="350" y="393" text-anchor="middle" font-size="10" fill="#64748b">实际跑 provider / CLI，带 fallback</text>
  <line x1="350" y1="400" x2="350" y2="428" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar2)"/>
  <rect x="170" y="430" width="360" height="40" rx="6" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="1.2"/>
  <text x="350" y="447" text-anchor="middle" font-size="11" font-weight="600" fill="currentColor">提取 output.text，组装结果</text>
  <text x="350" y="463" text-anchor="middle" font-size="10" fill="#64748b">RunMediaUnderstandingFileResult</text>
  <text x="350" y="500" text-anchor="middle" font-size="10" fill="#94a3b8">finally: cache.cleanup()</text>
</svg>
<span class="figure-caption">图 R13.2 ｜ runMediaUnderstandingFile 六步处理管线，含两个 early-exit 分支</span>
...
<svg viewBox="0 0 760 360" xmlns="http://www.w3.org/2000/svg" class="figure-svg" role="img" aria-label="provider 插件从 manifest 声明到最终方法调用的五步接入路径">
  <defs>
  ...
  <rect x="140" y="10" width="440" height="42" rx="6" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="1.2"/>
  <text x="360" y="27" text-anchor="middle" font-size="12" font-weight="600" fill="currentColor">插件的 manifest 声明它提供 "speechProviders" 能力</text>
  <text x="360" y="44" text-anchor="middle" font-size="10" fill="#64748b">plugin-sdk/* / manifest metadata</text>
  <line x1="360" y1="52" x2="360" y2="76" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar3)"/>
  <rect x="140" y="78" width="440" height="42" rx="6" fill="#ddd6fe" stroke="#7c3aed" stroke-width="1.5"/>
  <text x="360" y="95" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">插件加载时，SpeechProviderPlugin 实例</text>
  <text x="360" y="112" text-anchor="middle" font-size="10" fill="#64748b">被注册进 active runtime registry</text>
  <line x1="360" y1="120" x2="360" y2="144" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar3)"/>
  <rect x="140" y="146" width="440" height="42" rx="6" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="1.2"/>
  <text x="360" y="163" text-anchor="middle" font-size="12" font-weight="600" fill="currentColor">core 的 provider-registry</text>
  <text x="360" y="180" text-anchor="middle" font-size="10" fill="#64748b">通过 resolvePluginCapabilityProvider 读到它</text>
  <line x1="360" y1="188" x2="360" y2="212" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar3)"/>
  <rect x="140" y="214" width="440" height="42" rx="6" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/>
  <text x="360" y="231" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">能力运行时拿到 provider 实例</text>
  <text x="360" y="248" text-anchor="middle" font-size="10" fill="#64748b">synthesizeSpeech / generateImage / ...</text>
  <line x1="360" y1="256" x2="360" y2="280" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar3)"/>
  <rect x="140" y="282" width="440" height="42" rx="6" fill="#99f6e4" stroke="#0d9488" stroke-width="1.5"/>
  <text x="360" y="299" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">调用 provider 的方法</text>
  <text x="360" y="316" text-anchor="middle" font-size="10" fill="#64748b">synthesize / createBridge / generateImage / ...</text>
</svg>
<span class="figure-caption">图 R13.3 ｜ provider 插件通过 manifest → registry → 运行时的五步接入路径</span>
...
<svg viewBox="0 0 880 440" xmlns="http://www.w3.org/2000/svg" class="figure-svg" role="img" aria-label="全章七种能力数据流：左侧入站理解方向，右侧出站生成朗读方向，中间实时通话双向">
  <defs>
  ...
  <rect x="10" y="10" width="380" height="28" rx="4" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="1"/>
  <text x="200" y="29" text-anchor="middle" font-size="13" font-weight="700" fill="#ea580c">入站方向（理解）</text>
  <rect x="490" y="10" width="380" height="28" rx="4" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="1"/>
  <text x="680" y="29" text-anchor="middle" font-size="13" font-weight="700" fill="#0d9488">出站方向（生成 / 朗读）</text>
  <rect x="50" y="52" width="290" height="32" rx="6" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/>
  <text x="195" y="73" text-anchor="middle" font-size="12" font-weight="600" fill="currentColor">用户发图 / 语音 / 视频</text>
  <line x1="195" y1="84" x2="195" y2="108" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar4)"/>
  <rect x="540" y="52" width="290" height="32" rx="6" fill="#99f6e4" stroke="#0d9488" stroke-width="1.5"/>
  <text x="685" y="73" text-anchor="middle" font-size="12" font-weight="600" fill="currentColor">助手产出文本回复</text>
  <line x1="685" y1="84" x2="685" y2="108" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar4)"/>
  <rect x="30" y="110" width="330" height="56" rx="6" fill="#fed7aa" stroke="#ea580c" stroke-width="1.5"/>
  <text x="195" y="128" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">media-understanding</text>
  <text x="195" y="144" text-anchor="middle" font-size="10" fill="#64748b">scope 检查 · 多 provider fallback · 决策树记录</text>
  <line x1="195" y1="166" x2="195" y2="188" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar4)"/>
  <rect x="520" y="110" width="330" height="56" rx="6" fill="#99f6e4" stroke="#0d9488" stroke-width="1.5"/>
  <text x="685" y="128" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">tts-config</text>
  <text x="685" y="144" text-anchor="middle" font-size="10" fill="#64748b">判定是否朗读 + 选音</text>
  <line x1="685" y1="166" x2="685" y2="188" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar4)"/>
  <rect x="60" y="190" width="270" height="32" rx="6" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="1.2"/>
  <text x="195" y="211" text-anchor="middle" font-size="11" font-weight="600" fill="currentColor">文本（描述/转写）送入模型</text>
  <rect x="520" y="190" width="330" height="32" rx="6" fill="#99f6e4" stroke="#0d9488" stroke-width="1.5"/>
  <text x="685" y="211" text-anchor="middle" font-size="11" font-weight="700" fill="currentColor">tts-runtime (speech-core 门面)</text>
  <line x1="685" y1="222" x2="685" y2="244" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar4)"/>
  <rect x="520" y="246" width="330" height="32" rx="6" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="1.2"/>
  <text x="685" y="267" text-anchor="middle" font-size="11" font-weight="600" fill="currentColor">SpeechProvider.synthesize / stream</text>
  <line x1="685" y1="278" x2="685" y2="300" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar4)"/>
  <rect x="520" y="302" width="330" height="32" rx="6" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="1.2"/>
  <text x="685" y="323" text-anchor="middle" font-size="11" font-weight="600" fill="currentColor">audio Buffer / ReadableStream</text>
  <line x1="685" y1="334" x2="685" y2="356" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar4)"/>
  <rect x="520" y="358" width="330" height="52" rx="6" fill="#ddd6fe" stroke="#7c3aed" stroke-width="1.5"/>
  <text x="685" y="376" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">媒体落盘 (src/media/store.ts)</text>
  <text x="685" y="392" text-anchor="middle" font-size="10" fill="#64748b">路径安全校验 · 0o700/0o644 · 2 分钟 TTL</text>
  <line x1="685" y1="410" x2="685" y2="428" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar4)"/>
  <text x="685" y="440" text-anchor="middle" font-size="11" font-weight="600" fill="#0d9488">发送给用户</text>
  <line x1="440" y1="10" x2="440" y2="440" stroke="#cbd5e1" stroke-width="1" stroke-dasharray="5,4"/>
  <rect x="10" y="258" width="420" height="80" rx="6" fill="#f1f5f9" stroke="#7c3aed" stroke-width="1.2" stroke-dasharray="4,3"/>
  <text x="220" y="276" text-anchor="middle" font-size="11" font-weight="700" fill="#7c3aed">── 实时通话（双向）──</text>
  <text x="220" y="293" text-anchor="middle" font-size="10" fill="#64748b">Talk: RealtimeVoiceBridge</text>
  <text x="220" y="309" text-anchor="middle" font-size="10" fill="#64748b">audio-codec 重采样 + μ-law · TalkSessionController 回合状态机</text>
  <text x="220" y="325" text-anchor="middle" font-size="10" fill="#64748b">工具调用闭环</text>
  <rect x="10" y="358" width="420" height="52" rx="6" fill="#f1f5f9" stroke="#0ea5e9" stroke-width="1.2" stroke-dasharray="4,3"/>
  <text x="220" y="376" text-anchor="middle" font-size="11" font-weight="700" fill="#0ea5e9">── 生成（图/视频/音乐）──</text>
  <text x="220" y="393" text-anchor="middle" font-size="10" fill="#64748b">media-generation 共享层 · resolveCapabilityModelCandidates</text>
  <text x="220" y="409" text-anchor="middle" font-size="10" fill="#64748b">参数归一化（尺寸/宽高比）· image/video/music provider</text>
</svg>
<span class="figure-caption">图 R13.4 ｜ 全章七种能力数据流总览：入站理解（左）、出站生成朗读（右）、实时通话（中左）</span>
